...
WaypointFlyingModule::on_configure(const rclcpp_lifecycle::State &state)
{
  ...
  subscribe_waypoint_v2_event_service = this->create_service<psdk_interfaces::srv::SubscribeWaypointV2Event>("dji_osdk_ros/waypointV2_subscribeMissionEvent", std::bind(&WaypointFlyingModule::subscribe_waypoint_v2_event_callback, this, std::placeholders::_1, std::placeholders::_2));
  subscribe_waypoint_v2_state_service = this->create_service<psdk_interfaces::srv::SubscribeWaypointV2State>("dji_osdk_ros/waypointV2_subscribeMissionState", std::bind(&WaypointFlyingModule::subscribe_waypoint_v2_state_callback, this, std::placeholders::_1, std::placeholders::_2));
  pause_waypoint_v2_mission_service = this->create_service<psdk_interfaces::srv::PauseWaypointV2Mission>("dji_osdk_ros/waypointV2_pauseMission", std::bind(&WaypointFlyingModule::pause_waypoint_v2_mission_callback, this, std::placeholders::_1, std::placeholders::_2));
  resume_waypoint_v2_mission_service = this->create_service<psdk_interfaces::srv::ResumeWaypointV2Mission>("dji_osdk_ros/waypointV2_resumeMission", std::bind(&WaypointFlyingModule::resume_waypoint_v2_mission_callback, this, std::placeholders::_1, std::placeholders::_2));
  stop_waypoint_v2_mission_service = this->create_service<psdk_interfaces::srv::StopWaypointV2Mission>("dji_osdk_ros/waypointV2_stopMission", std::bind(&WaypointFlyingModule::stop_waypoint_v2_mission_callback, this, std::placeholders::_1, std::placeholders::_2));
  start_waypoint_v2_mission_service = this->create_service<psdk_interfaces::srv::StartWaypointV2Mission>("dji_osdk_ros/waypointV2_startMission", std::bind(&WaypointFlyingModule::start_waypoint_v2_mission_callback, this, std::placeholders::_1, std::placeholders::_2));
  download_waypoint_v2_mission_service = this->create_service<psdk_interfaces::srv::DownloadWaypointV2Mission>("dji_osdk_ros/waypointV2_downloadMission", std::bind(&WaypointFlyingModule::download_waypoint_v2_mission_callback, this, std::placeholders::_1, std::placeholders::_2));
  upload_waypoint_v2_mission_service = this->create_service<psdk_interfaces::srv::UploadWaypointV2Mission>("dji_osdk_ros/waypointV2_uploadMission", std::bind(&WaypointFlyingModule::upload_waypoint_v2_mission_callback, this, std::placeholders::_1, std::placeholders::_2));
  generate_waypoint_v2_action_service = this->create_service<psdk_interfaces::srv::GenerateWaypointV2Action>("dji_osdk_ros/waypointV2_generateActions", std::bind(&WaypointFlyingModule::generate_waypoint_v2_action_callback, this, std::placeholders::_1, std::placeholders::_2));
  
  init_waypoint_v2_setting_service = this->create_service<psdk_interfaces::srv::InitWaypointV2Setting>("dji_osdk_ros/waypointV2_initSetting", std::bind(&WaypointFlyingModule::init_waypoint_v2_setting_callback, this, std::placeholders::_1, std::placeholders::_2));
  upload_waypoint_v2_action_service = this->create_service<psdk_interfaces::srv::UploadWaypointV2Action>("dji_osdk_ros/waypointV2_uploadActions", std::bind(&WaypointFlyingModule::upload_waypoint_v2_action_callback, this, std::placeholders::_1, std::placeholders::_2));
